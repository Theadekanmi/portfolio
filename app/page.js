      ...
      <main>
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h1 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-3 md:mb-4">
              I'm Adekanmi — I design, build, and optimize smooth,
              high-performing digital experiences for the web.
            </h1>
        ...
        <section id="about" className="pt-20 pb-16 bg-white dark:bg-gray-900">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-2xl md:text-3xl text-blue-500 text-center font-semibold mb-10 leading-relaxed max-w-3xl mx-auto">
              “Great design is more than how it looks — it's how it works,
              feels, and flows. Code is my language, design is my voice. I build
              digital experiences that speak, solve, and scale.”
            </h2>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                <p className="leading-relaxed mb-6">
                  I'm Adekanmi, a Full-Stack Developer with a focus on crafting
                  visually compelling, high-performance web experiences. On the
                  front end, I specialize in responsive design, clean, scalable
                  code, and user-first interfaces that not only look stunning
                  but also perform seamlessly across devices. Leveraging the
                  power of React and Next.js, I build smooth, fast-loading
                  websites and optimize performance for both users and search
                  engines. I'm also experienced with Python and Django, allowing
                  me to create robust backend systems that power dynamic and
                  scalable applications. Additionally, with my background in
                  Public Administration from The Oke Ogun Polytechnic, Saki, I
                  approach problem-solving with structure and efficiency. Having
                  knowledge in Project Management further enhances my ability to
                  stay organized, streamline workflows, and approach projects
                  strategically. Beyond development, I help startups and
                  individuals optimize their websites for speed and
                  responsiveness, ensuring that every site I touch loads
                  quickly, works efficiently, and provides a seamless experience
                ...
                >
                  ...
                  <ul className="space-y-3 text-sm">
                    ...
                    <li className="border-b border-blue-300 pb-2">
                      AI Career Essential (Aice) — ALX Africa (2024)
                    </li>
                    <li className="border-b border-blue-300 pb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Connects users with nearby recycling facilities and buyers,
                    simplifying logistics and integrating AI for measuring and
                    weighing metals.
                  </p>
                  <a
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    <span className="px-2 py-1 border border-blue-500 text-blue-500 rounded-full text-xs">
                      HTML
                    </span>
                    <span className="px-2 py-1 border border-green-500 text-green-500 rounded-full text-xs">
                      CSS
                    </span>
                    <span className="px-2 py-1 border border-yellow-500 text-yellow-500 rounded-full text-xs">
                      JavaScript
                    </span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Sleek, modern site for an upscale continental restaurant
                    blending European, Asian, and African cuisine in a
                    sophisticated UI.
                  </p>
                  <a
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Responsive restaurant website with clean layout, dynamic
                    menu display, and easy navigation for reservations.
                  </p>
                  <a
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Modern app for airtime/data top‑ups, bill payments, and
                    digital services—fast, reliable, and affordable.
                  </p>
                  <a
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Community‑focused app for church members: share sermons,
                    events, updates, and foster engagement.
                  </p>
                  <a
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4 leading-relaxed">
                    Healthcare app to connect patients with providers, manage
                    appointments, and access health resources seamlessly.
                  </p>
                  <a
        ...
        <section id="tried" className="pt-24 pb-12 bg-white dark:bg-gray-900">
          <div className="container mx-auto px-6">
            <h1
              className="flex justify-center font-bold text-4xl p-3 text-white"
              data-aos="fade-in"
            >
              MY GO-TO DEVELOPMENT <br /> METHODS
            </h1>
            <div
              className="flex flex-col md:flex-row items-center justify-between gap-10 mt-10 p-3 m-3"
              data-aos="fade-out"
            >
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300 mt-10">
                <p className="p-3 font-bold">(I)</p>
                <h2 className="p-2 font-bold mt-2">
                  USER-CENTERED DESIGN: BUILDING WITH THE USER IN MIND
                </h2>
                <p className="p-3 text-gray-500 font-bold mt-3">
                  By collaborating closely with designers, I focus on delivering
                  user-centered solutions that prioritize usability,
                  accessibility, and seamless navigation, ensuring that every
                  interface is both intuitive and purposeful for its users.
                </p>
              </div>
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  My projects are designed to perform beautifully on any device,
                  from desktops to smartphones, delivering smooth, responsive
                  layouts that adjust fluidly to every screen.
                </p>
              </div>
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  I follow a component-driven approach, breaking down complex
                  interfaces into small, reusable, and manageable pieces for
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300 mt-10">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  Through Web Performance Engineering, I optimize code, images,
                  and server responses to deliver high-speed, efficient digital
                  experiences.
                </p>
              </div>
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  I ensure multi-browser support, delivering consistent
                  functionality and visuals across Chrome, Firefox, Safari,
                  Edge, and other modern browsers.
                </p>
              </div>
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                <p className="p-2 font-bold">(III)</p>
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  Through collaborative development practices, I work
                  efficiently within teams, ensuring smooth code integration and
                  conflict resolution.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-6">
            ...
            >
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300 mt-10">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  I actively engage in continuous learning and growth by
                  exploring new frameworks, tools, and industry best practices
              ...
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  I follow clean, maintainable code principles to ensure my
                  projects are scalable, readable, and easy to enhance or debug.
                </p>
              </div>
              <div className="md:w-1/2 text-gray-700 dark:text-gray-300">
                <p className="p-2 font-bold">(III)</p>
                ...
                <p className="p-3 text-gray-500 font-bold mt-3">
                  ...
                  designers, developers, and stakeholders to ensure seamless
                  project delivery.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
                  <li>
                    Collaborated with a multidisciplinary team of 3MTT
                    participants from UI/UX, Data Analysis, and AI/Machine
                    Learning tracks.
                  </li>
                  <li>
                    Developed a web application enabling users to buy and sell
                    scrap metals in a streamlined marketplace platform.
                  </li>
                  <li>
                    Handled frontend development using HTML, CSS, and
                    JavaScript, integrating responsive UI components and
                    interactive features.
                  </li>
                  <li>
                    Worked closely with the AI/ML member to incorporate
                    intelligent scrap pricing suggestions based on market data.
                  </li>
                  <li>
                    Coordinated with the Data Analyst to visualize market trends
                    and transaction history using interactive charts.
                  </li>
                </ul>
              </div>
              ...
              >
                <h3 className="text-2xl font-semibold text-blue-500 mb-2">
                  Team Lead — Africa Health Care and Education (ALX Prototype
                  Project)
                </h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">2024</p>
                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
                  <li>
                    Led a cross-functional team in designing a prototype for
                    Africa Health Care and Education, a platform aimed at
                    connecting healthcare professionals and educators across
                    Africa for mentorship and knowledge sharing.
                  </li>
                  <li>
                    Coordinated task delegation, project milestones, and
                    progress tracking to deliver the prototype within deadlines.
                  </li>
                  <li>
                    Facilitated effective communication between team members
                    with diverse skill sets, fostering a productive and
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
                  <li>
                    Designed and built portfolio and business websites for
                    clients using Next.js and Tailwind CSS.
                  </li>
                  <li>
                    Implemented custom features like contact forms, blog
                    sections, and interactive animations.
                  </li>
                  <li>
                    Ensured cross-browser compatibility and mobile
                    responsiveness for all projects.
                  </li>
                </ul>
              </div>
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
                  <li>
                    Worked on real-world frontend projects using HTML, CSS, and
                    JavaScript.
                  </li>
                  <li>
                    Collaborated with a development team to improve user
              ...
              >
                ...
                <ul className="list-disc pl-5 text-gray-700 dark:text-gray-300 space-y-1">
                  <li>
                    Developed and maintained responsive web pages using modern
                    frontend technologies.
                  </li>
                  <li>
                    Contributed to the design and functionality improvements of
                    client websites.
                  </li>
                </ul>
              </div>
